											...
											<div class="main-signup-header">
												...
												<form method="POST" action="{{ route('login.user') }}">
													...
													<div class="form-group">
														<label>Email</label> <input class="form-control" placeholder="Enter your email" t type="email" name="email" :value="old('email')" required autofocus autocomplete="username" >
													</div>
													<div class="form-group">
